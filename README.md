...
This plugin is freely available on GitHub for developers to test. However, that if you do end up using our plugin on a production website, [pay what you want here](https://gum.co/stripeWPeC). 
